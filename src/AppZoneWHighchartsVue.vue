<template>
    <div class="bkh">
        ...
        <div class="head1"><span style="cursor:pointer;" title="open for copy link to view component" onclick="window.open('//yuda-lyu.github.io/w-highcharts-vue/examples/app.html?cmp='+this.innerText,'_blank')">w-highcharts-vue</span></div>
        ...
        <div>
            ...
            <div class="bk">
                ...
                <w-highcharts-vue
                    style="width:620px;"
                    :options="WHighchartsVue.options1"
                ></w-highcharts-vue>
            ...
            <div class="bk">
                ...
                <w-highcharts-vue
                    style="width:620px;"
                    :options="WHighchartsVue.options2"
                ></w-highcharts-vue>
            ...
            <div class="bk">
                ...
                <w-highcharts-vue
                    style="width:620px;"
                    :options="WHighchartsVue.options3"
                ></w-highcharts-vue>
            ...
            <div class="bk">
                ...
                <w-highcharts-vue
                    style="width:620px;"
                    :options="WHighchartsVue.options4"
                ></w-highcharts-vue>
            ...
            <div class="bk">
                ...
                <w-highcharts-vue
                    style="width:620px;"
                    :options="WHighchartsVue.options5"
                ></w-highcharts-vue>
            ...
            <div class="bk">
                ...
                <w-highcharts-vue
                    style="width:620px;"
                    :options="WHighchartsVue.options6"
                ></w-highcharts-vue>
