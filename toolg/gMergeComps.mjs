...
let fn_tar = 'WHighchartsVueAll.vue' //因WHighchartsVue.vue已是繪圖組件, 故合併安裝用組件另取名WHighchartsVueAll


function main() {
    //讀取components裡面組件, 自動生成WHighchartsVueAll, 供rollup打包整體組件
...
let WHighchartsVueAll = {
    install: function(Vue) {
${_.join(c2, '\r\n')}
    }
}

export default WHighchartsVueAll
</script>
